...
class _HistoryScreenState extends State<HistoryScreen>
  ...
  Widget ordersScreen(orderList) {
    final List<OrdersList> currentOrders = orderList
        .where((OrdersList i) => i.orderStatus != 'delivered')
        .toList();
    final List<OrdersList> pastOrders = orderList
        .where((OrdersList i) => i.orderStatus == 'delivered')
        .toList();
    final _tabBody = [
      showOrder(currentOrders, true),
      showOrder(pastOrders, false),
    ];
    return Scaffold(
      key: _scaffoldKey,
  ...
  Widget showOrder(orderList, isCurrent) {
    OrderListNotifier orderListNotifier =
        Provider.of<OrderListNotifier>(context, listen: false);
    return orderList.isEmpty
        ? emptyScreen(
            "assets/images/noHistory.svg",
            isCurrent ? "No current orders" : "No past orders",
            isCurrent
                ? "Your current orders will be displayed here."
                : "Your past/cancelled orders will be displayed here.",
          )
        : Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, i) {
                  ...
                  var orderTotalPrice = orderTotalPriceList
                      ...
                      .toStringAsFixed(2);
                  var orderDayTime =
                      orderListItem.orderDate.toDate().day.toString() +
                          "-" +
                              ...
                              Container(
                                ...
                                child: RawMaterialButton(
                                  ...
                                  child: Text(
                                    "Details",
                                    style:
                                        boldFont(MColors.primaryPurple, 14.0),
                                  ),
                                ),
                              ),
                              Spacer(),
